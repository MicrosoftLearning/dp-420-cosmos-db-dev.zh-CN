...
1. 切换回 Web 浏览器并打开新的标签页，然后导航到 Azure 门户 (``portal.azure.com``)。
...
1. 选择“+ 创建资源”****，搜索“数据工厂”**，然后使用以下设置创建新的“数据工厂”**** 资源，并将所有其余设置保留为默认值：
...
1. 在向导的“源”**** 步骤中，选择“源类型”**** 列表中的“Azure Cosmos DB for NoSQL”****。

1. 在“连接”部分，选择“+ 新建连接”。

1. 在“新建连接(Azure Cosmos DB for NoSQL)”**** 弹出窗口中，配置具有以下值的新连接，然后选择“创建”****：
...
1. 在向导的“目标”**** 步骤中，选择“目标类型”**** 列表中的“Azure Cosmos DB for NoSQL”****。
...
1. 返回到具有你的 Azure Cosmos DB 帐户**** 的浏览器选项卡，并导航到“数据资源管理器”**** 窗格。
